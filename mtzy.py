...
class Spider(Spider):
    api_host = 'https://caiji.maotaizy.cc'
    origin = 'https://mtzy.me/'
    api_path = '/api/search'
    headers = {
    ...
    def homeContent(self, filter):
        return {'class': [{'type_id': 1, 'type_name': '电影'}, {'type_id': 2, 'type_name': '电视剧'}, {'type_id': 3, 'type_name': '综艺片'}, {'type_id': 4, 'type_name': '动漫'}, {'type_id': 34, 'type_name': '伦理片'}, {'type_id': 37, 'type_name': '短剧大全'}]}
